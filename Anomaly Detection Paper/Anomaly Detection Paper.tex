...
Anomaly detection is a technique which is used to detect abnormal observations generated by a system. Anomaly detection is usually a domain specific problem. Therefore, it has been researched and implemented in many applications ranging diverse fields e.g. medical data \cite{Chandola:2009:ADS:1541880.1541882,10.1007/3-540-44795-4_26}, anomaly power consumption \cite{ARAYA2017191}, and cyber secrity \cite{Kruegel:2003:ADW:948109.948144,6786500} are among many. Anomaly detection in power consumption is vital because roughly 60\% of the world’s electricity is consumed by residential buildings and by commercial sector (Araya, Grolinger, ELYamany, Capretz, \& Bitsuamlak, 2017). The growth in the demand of power as well infrastructure of generation and distribution along with several constraints in order to meet the rising demands is one of the of the biggest problem, especially in developing countries. Anomaly detection in electricity consumption is of great significance because it can help reducing the wastage of electricity consumption generated by various sources including equipment or human related fault as unexpected variations can incur additional operating costs to their facilities. These fluctuations in electricity consumption can arise from various factors such as excessive use of heavy equipment like electric heaters in winters, room coolers during the summers or unusually high number of customers just before any public holiday etc.


One approach towards the detection of abnormality in energy consumption is to monitor energy consumption, manually. Once abnormality is found, it can be reported to concerned authorities in order to take due action to rectify it. However, this approach requires a lot of human effort. Therefore, this solution is less desirable. Another, possible solution is to first learn the machine learning or statistical model, and then later predict anomaly based on the leaned model \cite{ARAYA2017191,inproceedings1}   
In this study, we have proposed a method that not only detect anomalies but also categorizes the given anomalous inputs into one of three categories, small, medium or big. Our method is divided into two steps: self labeling based on modified version of Tukey\textquotesingle s test \cite{doi:10.1080/00031305.1978.10479236,Haynes2013}, and then the calculation of Probability density function (PDF) of gaussian distribution (Singh \& Rajgopal, 1985). The parameters of gaussian distribution were estimated   using maximum likelihood estimation (MLE) \cite{10.2307/1402471}. We have compared the classification accuracy of our method with a semi-supervised sparse undercomplete autoencoder. The evaluation of models was performed on the data collected from 227 different superstores over the time period of 11 months owned by Tengleman warenhandelsgesellschaft KG, independently.


%The growth in the demand of power as well infrastructure of generation and distribution along with several constraints in order to meet the rising demands is one of the of the biggest problem, especially in developing countries.
...
\begin{figure*}[h]
	\centering
	\includegraphics[width=13cm,height=5.5cm]{figures/All_stores.jpg}
...
\begin{figure*}[h]
	\centering
	\includegraphics[width=13cm,height=5.5cm]{figures/jan_all_stores.jpg}
...
\begin{figure*}[h]
	\centering
	\includegraphics[width=13cm,height=5.5cm]{figures/store_105_all.jpg}
	\caption{Energy Consumption by Store 105  between August 2015 and June 2016}
	\label{fig:store_105_all}
\end{figure*}

%SvGInclude() jannis10000@gmail.com
...
\begin{figure}[t]
	\centering
	\includegraphics[width=6cm,height=2.5cm]{figures/IQR3.jpg}
...
value of $\beta$ the higher the chance of getting the test input as an anomaly and vice versa. 
\begin{equation}
y-\beta\sigma \leq x \leq y + \beta\sigma 
\end{equation}
\newline
where, \newline
$y$ is output \newline
...
\begin{figure}[h]
	%\centering
	\begin{flushleft}
			\includegraphics[width=\linewidth]{figures/all_days_st_05_jan_with_OL.jpg}
...
\begin{figure}[h]
	...
	\includegraphics[width=\linewidth]{figures/all_days_st_05_jan_wo_OL.jpg}
...
\begin{figure}[H]
	...
	{
		\includegraphics[width=2.5in]{figures/conf_anomaly.jpg}
		%\caption{ROC curve of Anomaly Detection Algorithm.}
		\label{fig:boat1}
	}
	\subfigure[Confusion Matrix of Autoencoder.]
	{
		\includegraphics[width=2.5in]{figures/Conf_autoencoder.jpg}
		\label{fig:boat2}
	}
...
\begin{figure}[H]
	...
	{
		\includegraphics[width=2.5in]{figures/roc_anomaly.jpg}
		
		\label{fig:gull}
	}
	\subfigure[ROC curve of Autoencoder.]
	{
		\includegraphics[width=2.5in]{figures/roc_autoencoder.jpg}
		\label{fig:tiger}
	}
	\caption{ROC curves}
	\label{fig:ROC}
